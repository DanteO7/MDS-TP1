...
import { PortafolioFacade } from "./portfolio-facade";
...
// Instancias globales de cada Fachada con Inyeccion de Dependencia
...
export const PortafolioStorage = new PortafolioFacade(storage);
